...
```
binary "https://github.com/EkoCommunications/EkoMessagingSDKUIKit/releases/download/1.11.4/UpstraUIKit.json" ~> 1.11.4
```

> Note: You can change 1.11.4 with the supported release tag
...
| 1.11.4 | 4.7.0 | iOS 12.0 | Swift 5.3.1
