...
```
binary "https://github.com/EkoCommunications/EkoMessagingSDKUIKit/releases/download/1.12.0/UpstraUIKit.json" ~> 1.12.0
```

> Note: You can change 1.12.0 with the supported release tag
...
```
pod 'UpstraUIKit', '1.12.0', :source => "https://github.com/EkoCommunications/EkoMessagingSDKUIKit.git"
```
...
| 1.12.0 | 4.7.0 | iOS 12.0 | Swift 5.3.1
