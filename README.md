...
```
binary "https://github.com/EkoCommunications/EkoMessagingSDKUIKit/releases/download/1.0.0/UpstraUIKit.json" ~> 1.5.3
```
...
```
pod 'UpstraUIKit', '1.5.3', :source => "https://github.com/EkoCommunications/EkoMessagingSDKUIKit.git"
```
