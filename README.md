...
```
binary "https://github.com/EkoCommunications/EkoMessagingSDKUIKit/releases/download/1.9.1/UpstraUIKit.json" ~> 1.9.1
```
...
```
pod 'UpstraUIKit', '1.9.1', :source => "https://github.com/EkoCommunications/EkoMessagingSDKUIKit.git"
```
