...
```
binary "https://github.com/EkoCommunications/EkoMessagingSDKUIKit/releases/download/1.9.2/UpstraUIKit.json" ~> 1.9.2
```
...
```
pod 'UpstraUIKit', '1.9.2', :source => "https://github.com/EkoCommunications/EkoMessagingSDKUIKit.git"
```
...
| 1.9.2 | 4.6.0 | iOS 11 | Swift 5.3.1
