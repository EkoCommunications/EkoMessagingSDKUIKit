...
```
binary "https://github.com/EkoCommunications/EkoMessagingSDKUIKit/releases/download/0.1.0/UpstraUIKit.json" ~> 0.1.0
```
...
```
pod 'UpstraUIKit', '0.1.0', :source => "https://github.com/EkoCommunications/EkoMessagingSDKUIKit.git"
```
