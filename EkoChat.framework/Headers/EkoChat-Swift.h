...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EkoChat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcode
SWIFT_CLASS("_TtC7EkoChat13OnAckCallback")
...
SWIFT_CLASS("_TtC7EkoChat11SSLSecurity")
...
SWIFT_CLASS("_TtC7EkoChat16SocketAckEmitter")
...
SWIFT_CLASS("_TtC7EkoChat14SocketAnyEvent")
...
SWIFT_CLASS("_TtC7EkoChat12SocketEngine")
...
SWIFT_PROTOCOL("_TtP7EkoChat18SocketEngineClient_")
@protocol SocketEngineClient
...
SWIFT_PROTOCOL("_TtP7EkoChat16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC7EkoChat14SocketIOClient")
...
SWIFT_PROTOCOL("_TtP7EkoChat17SocketManagerSpec_")
...
/// \param forNamespace The namespace for the socket.
///
///
/// returns:
...
/// To disconnect a socket and remove it from the manager, either call <code>SocketIOClient.disconnect()</code> on the socket,
/// or call one of the <code>disconnectSocket</code> methods on this class.
SWIFT_CLASS("_TtC7EkoChat13SocketManager")
